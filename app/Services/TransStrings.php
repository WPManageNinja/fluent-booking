...
class TransStrings
{
    ...
    public static function getStrings()
    {
        return array(
            ...
            '5 Minutes'                                                                        => sprintf(__('%d Minutes', 'fluent-booking-pro'), 5),
            '10 Minutes'                                                                       => sprintf(__('%d Minutes', 'fluent-booking-pro'), 10),
            '20 Minutes'                                                                       => sprintf(__('%d Minutes', 'fluent-booking-pro'), 20),
            '30 Minutes'                                                                       => sprintf(__('%d Minutes', 'fluent-booking-pro'), 30),
            '40 Minutes'                                                                       => sprintf(__('%d Minutes', 'fluent-booking-pro'), 40),
            '50 Minutes'                                                                       => sprintf(__('%d Minutes', 'fluent-booking-pro'), 50),
            '60 Minutes'                                                                       => sprintf(__('%d Minutes', 'fluent-booking-pro'), 60),
            '2 Hours'                                                                          => sprintf(__('%d Hours', 'fluent-booking-pro'), 2),
            '3 Hours'                                                                          => sprintf(__('%d Hours', 'fluent-booking-pro'), 3),
            '6 Hours'                                                                          => sprintf(__('%d Hours', 'fluent-booking-pro'), 6),
            '12 Hours'                                                                         => sprintf(__('%d Hours', 'fluent-booking-pro'), 12),
