...
class NewBookingTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'fluent_booking/after_booking_scheduled';
        $this->actionArgNum = 1;
        $this->priority = 20;
        parent::__construct();
    }
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('New Booking (Fluent Booking)', 'fluent-crm'),
            'description' => __('This Funnel will be initiated when a new booking has been confirmed', 'fluent-crm'),
