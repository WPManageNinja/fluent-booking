...
class ElementorIntegration
{
    ...
    {
        \Elementor\Plugin::instance()->widgets_manager->register(new \FcalCalendarEvent());
        \Elementor\Plugin::instance()->widgets_manager->register(new \FcalBookings());
        \Elementor\Plugin::instance()->widgets_manager->register(new \FcalCalendar());
    }
