...
class EmailNotificationService
{
    ...
    public static function emailToGuestOnOneHourReminder($booking, $slot = null)
    {
        ...
        do_action('fluent_calendar/log_booking_note', [
            'title'       => 'One hour reminder to guest',
            'type'        => 'activity',
            'description' => sprintf(__('One hour reminder email sent to guest. Email Subject: %s'), $subject),
    ...
    public static function emailToHostOnOneHourReminder($booking, $slot = null)
    {
        ...
        do_action('fluent_calendar/log_booking_note', [
            'title'       => 'One hour reminder to host',
            'type'        => 'activity',
            'description' => sprintf(__('One hour reminder email sent to host. Email Subject: %s'), $subject),
            'booking_id'  => $booking->id
        ]);
    ...
    public static function emailToGuest15MinutesReminder($booking, $slot = null)
    {
        ...
        do_action('fluent_calendar/log_booking_note', [
            'title'       => '15 Minutes reminder to guest',
            'type'        => 'activity',
            'description' => sprintf(__('15 minutes reminder email sent to guest. Email Subject: %s'), $subject),
            'booking_id'  => $booking->id
        ]);
    ...
    public static function emailToHostOn15MinutesReminder($booking, $slot = null)
    {
        ...
        do_action('fluent_calendar/log_booking_note', [
            'title'       => '15 Minutes reminder to host',
            'type'        => 'activity',
            'description' => sprintf(__('15 minutes reminder email sent to host. Email Subject: %s'), $subject),
            'booking_id'  => $booking->id,
        ]);
    ...
    public static function bookingCancelledEmailToGuest($booking, $slot = null)
    {
        if (!$slot) {
            $slot = $booking->slot;
        }
        ...
        do_action('fluent_calendar/log_booking_note', [
            'title'       => 'Cancelled booking email sent to guest',
            'type'        => 'activity',
            'description' => sprintf(__('Cancellation email sent to guest. Email Subject: %s'), $subject),
            'booking_id'  => $booking->id
        ]);
    ...
    public static function bookingCancelledEmailToHost($booking, $slot = null)
    {
        ...
        do_action('fluent_calendar/log_booking_note', [
            'title'       => 'Cancelled booking email sent to host',
            'type'        => 'activity',
            'description' => sprintf(__('Cancellation email sent to host. Email Subject: %s'), $subject),
            'booking_id'  => $booking->id
        ]);
