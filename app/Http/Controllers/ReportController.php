...
class ReportController extends Controller
{
    ...
    public function getReports(Request $request)
    {
        ...
        $paymentWidget = $this->getPaymentWidgets();
    ...
    {
        // Get booking query by created_at and start_time
        ...
        $currentMonthStartBookings = Booking::whereBetween('start_time', [$currentMonthStart, $currentMonthEnd])->get();
        $lastMonthStartBookings = Booking::whereBetween('start_time', [$lastMonthStart, $lastMonthEnd])->get();
        ...
        // Calculate completed and cancelled based on 'start_time'
    ...
    {
        if ($lastMonthTotal > 0) {
            return intval(($currentMonthTotal - $lastMonthTotal) / $lastMonthTotal) * 100;
    ...
    private function getPaymentWidgets()
    {
        ...
        if (!$isAdmin) {
            $orderQuery->whereHas('booking', function ($q) {
                $q->where('host_user_id', get_current_user_id());
            });
        }
