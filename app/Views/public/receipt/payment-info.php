            ...
            <tr>
                <td>
                    <div class="fluent_booking_payment_info_item fluent_booking_payment_info_item_order_id">
                        <?php if ($order->items) : ?>
                            <div class="fluent_booking_item_heading"><?php _e('Order ID:', 'fluent-booking'); ?></div>
                        <?php else : ?>
                            <div class="fluent_booking_item_heading"><?php _e('Submission ID:', 'fluent-booking'); ?></div>
                        <?php endif; ?>
                ...
                <td>
                    <div class="fluent_booking_payment_info_item fluent_booking_payment_info_item_date">
                        <div class="fluent_booking_item_heading"><?php _e('Date:', 'fluent-booking'); ?></div>
                ...
                <td>
                    <div class="fluent_booking_payment_info_item fluent_booking_payment_info_item_total">
                        <div class="fluent_booking_item_heading"><?php _e('Total:', 'fluent-booking'); ?></div>
                ...
                <?php if ($order->payment_method) : ?>
                    <td>
                        <div class="fluent_booking_payment_info_item fluent_booking_payment_info_item_payment_method">
                            <div class="fluent_booking_item_heading"><?php _e('Payment Method:', 'fluent-booking'); ?></div>
                ...
                <?php if ($order->status && $order->items) : ?>
                        <td>
                            <div class="fluent_booking_payment_info_item fluent_booking_payment_info_item_payment_status">
                                <div class="fluent_booking_item_heading"><?php _e('Payment Status:', 'fluent-booking'); ?></div>
