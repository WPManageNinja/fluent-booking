                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td class="alert alert-warning"
                            ...
                            <?php printf(esc_html__('Your %s Booking Summary', 'fluent-booking-pro'), esc_html(ucfirst($frequency))); ?>
                        </td>
                    </tr>
                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        <?php printf(esc_html_e('Let\'s see how many events are booked in the last %d days.', 'fluent-booking-pro'), esc_html($days)); ?>
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        <table class="summary_table">
                                            <thead>
                                            <tr>
                                                <th><?php esc_html_e('Total New Booked', 'fluent-booking-pro'); ?></th>
                                                <th><?php esc_html_e('Total Meeting Completed', 'fluent-booking-pro'); ?></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                    ...
                    <table width="100%"
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="aligncenter content-block"
                                ...
                                <p style="margin: 0;"> <?php esc_html_e('This email has been generated by fluent booking', 'fluent-booking-pro'); ?> </p>
                            </td>
                        </tr>
                    </table>
                </div>
