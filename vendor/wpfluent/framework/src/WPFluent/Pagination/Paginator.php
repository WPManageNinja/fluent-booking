...
use FluentCalendar\Framework\Pagination\Presenter;
use FluentCalendar\Framework\Pagination\PaginatorInterface as PaginatorContract;
...
class Paginator extends AbstractPaginator implements ArrayableInterface, ArrayAccess, Countable, IteratorAggregate, JsonSerializable, JsonableInterface, PaginatorContract
{
     ...
     *
     * @param  \FluentCalendar\Framework\Pagination\Presenter|null  $presenter
     * @return string
     */
