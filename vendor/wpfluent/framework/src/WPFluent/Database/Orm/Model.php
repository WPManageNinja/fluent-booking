...
use FluentCalendar\Framework\Database\Orm\ModelHelperTrait;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity, UrlRoutable
{
	 ...
	 *
	 * @var \FluentCalendar\Framework\Foundation\Dispatcher
	 */
     ...
     *
     * @param  \FluentCalendar\Framework\Database\Eloquent\Scope|\Closure|string  $scope
     ...
     *
     * @param  \FluentCalendar\Framework\Database\Eloquent\Scope|string  $scope
     * @return bool
     */
     ...
     *
     * @param  \FluentCalendar\Framework\Database\Eloquent\Scope|string  $scope
     * @return \FluentCalendar\Framework\Database\Eloquent\Scope|\Closure|null
     */
     ...
     * @return $this
     *
     * @throws \FluentCalendar\Framework\Database\Eloquent\MassAssignmentException
     */
     ...
     * @param  array  $items
     * @param  string|null  $connection
     * @return \FluentCalendar\Framework\Database\Eloquent\Collection
     */
     ...
     *
     * @return \FluentCalendar\Framework\Database\Eloquent\Builder
     */
     ...
     * @return \FluentCalendar\Framework\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  array|string  $relations
     * @return \FluentCalendar\Framework\Database\Eloquent\Builder|static
     */
     ...
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\HasMany
     */
     ...
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  string  $relation
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\BelongsToMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\MorphToMany
     */
     ...
     *
     * @param  \FluentCalendar\Framework\Database\Eloquent\Builder  $query
     * @param  array  $options
     * @return bool
     */
     ...
     *
     * @return \FluentCalendar\Framework\Database\Orm\DateTime
     */
     ...
     *
     * @param  \FluentCalendar\Framework\Database\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @return \FluentCalendar\Framework\Database\Eloquent\Relations\Pivot
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'FluentCalendar\Framework\Database\Eloquent\Relations\Relation');
        }
     ...
     * @return \FluentCalendar\Framework\Database\Eloquent\Model
     */
     ...
     *
     * @return \FluentCalendar\Framework\Database\Connection
     */
     ...
     *
     * @return \FluentCalendar\Framework\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \FluentCalendar\Framework\Foundation\Dispatcher  $dispatcher
     * @return void
     */
