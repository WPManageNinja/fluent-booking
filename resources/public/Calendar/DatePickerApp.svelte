        ...
        <div class="calendar-container">
            ...
            {#if noAvailability}
                <div class="fcal_no_availability">
                    <h4>{i18('No availability in')} {getDateTimeStringI18(monthNames[month], 'month')}</h4>
                    {#if !prevDisabled}
                        <button aria-label="Previous Month" type="button" tabindex="0" on:click={()=>prev()}>
                    ...
                    {#if !nextDisabled && prevDisabled}
                        <button aria-label="Next Month" type="button" tabindex="0" on:click={()=>next()}>
                            {i18('View next month')}
