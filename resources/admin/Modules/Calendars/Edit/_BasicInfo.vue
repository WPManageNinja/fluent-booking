<template>
    <div class="fcal_create_calendar_form">
        ...
        <div class="fcal_create_calendar_form_body">
            <el-form v-model="localSlot" label-position="top">
                <el-form-item label="Event Name *" class="fcal_color_select_wrap">
                    <el-input
                        v-model="localSlot.title"
                ...
                <el-form-item label="Meeting Duration *">
                    <el-select v-model="localSlot.duration" placeholder="Select" popper-class="fcal_select">
                        <el-option
