            ...
            <table class="fcal_payment_history_table">
                ...
                <tfoot>
                    <tr>
                        <th></th>
                        <th>{{ $t('Total:') }}</th>
                        <td><span v-html="currencySign"></span>{{ Math.floor(payment_order.total_amount / 100) }}</td>
                    </tr>
                </tfoot>
            </table>
            ...
            <div v-if="payment_order.transaction && payment_order.transaction.id" class="fcal_payment_transaction_lists">
                ...
                <div class="fcal_schedule_details_event">
                    ...
                    <div class="fcal_schedule_details_event_item">
                        ...
                        <p>
                            <span v-html="currencySign"></span>{{ Math.floor(payment_order.transaction.total / 100) }}
                        </p>
                    </div>
                    <div class="fcal_schedule_details_event_item">
                        <h3>{{ $t('Payment Status') }}</h3>
                        <p class="payment_status" :class="payment_order.transaction.status">
                            {{ payment_order.transaction.status }}
                        </p>
                    </div>
