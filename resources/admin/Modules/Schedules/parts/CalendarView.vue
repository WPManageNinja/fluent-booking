    ...
    <div class="fcal_calendar_view">
        <el-calendar v-model="selectedDate">
            ...
            <template #date-cell="{ data }">
                ...
                <template v-if="formattedSchedules && formattedSchedules[data.day]">
                    <div v-for="(schedule, index) in formattedSchedules[data.day]" :key="schedule.id" class="fcal_booking_wrap">
                        <template v-if="index < 3">
                            ...
                            <el-popover
                                ...
                                <template #reference>
                                    <div class="booking_info" @click="showDetails(schedule)">
                        ...
                        <template v-else-if="index == 3">
                            <el-popover
                                ...
                                <template #reference>
                                    <div class="fcal_booking_wrap" @click="showAllSchedules(data.day)">
                                        ...
                                        <div class="fcal_all_schedules_body">
                                            <div v-for="booking in formattedSchedules[data.day]" :key="booking.id" class="fcal_all_schedules_wrap">
                                                ...
                                                <el-popover
                                                    ...
                                                    <template #reference>
                                                        <div class="schedule_info" @click="showDetailsSchedule(booking)">
